...
import { ReportSVG, MedicationSVGs, HealthDataSVG, MedicationTrackerSVG, DoctorSVG } from "@/assets/svgComponents/generalSVGs";
...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView>
      ...
      <TouchableOpacity onPress={() => router.push('/home/myDoctor')} style={styles.doctorsTab}>
        <DoctorSVG transform={'rotate(350)'} height={80} width={80} />
        <Text style={{ color: "white", fontSize: 20, fontWeight: "600", marginLeft: 15 }}>My Doctors</Text>
      </TouchableOpacity>
